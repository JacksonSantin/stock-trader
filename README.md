...
**Stock Trader** - Quarto projeto desenvolvido durante o curso **Curso Vue JS 2 - O Guia Completo (incl. Vue Router & Vuex)**.

Projeto consiste na criação de um corretor de ações utilizando o framework Vue.js e tudo que foi aprendido no decorrer do curso.
...
Consulte informações sobre a licença do projeto [MIT](https://github.com/JacksonSantin/stock-trader/blob/master/LICENSE).
